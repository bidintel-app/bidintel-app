  ...
  return (
    <div className="ai-matching-container">
      ...
      <div className="coming-soon-message">
        ...
        <p>We're building intelligent algorithms to match you with the perfect prime contractors based on your business capabilities, past performance, and contract requirements.</p>
